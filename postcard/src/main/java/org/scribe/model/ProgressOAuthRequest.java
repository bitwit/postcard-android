...
/**
 * Created by kylenewsome on 2014-09-16.
 */
public class ProgressOAuthRequest extends OAuthRequest {
    ...
    public UploadProgressCallback uploadProgressCallback = null;
     ...
     */
    public ProgressOAuthRequest(Verb verb, String url)
    {
        super(verb, url);
        this.verb = verb;
        this.url = url;
    ...
    void addBody(HttpURLConnection conn, byte[] content) throws IOException
    {
        ...
        OutputStream os = conn.getOutputStream(); //.write(content);
        ...
        while (bytesTransferred < totalSize) {
            ...
            os.write(content, bytesTransferred, nextChunkSize); // TODO check outcome!
            bytesTransferred += nextChunkSize;

            if(uploadProgressCallback != null){
                double progress = 100 * bytesTransferred / totalSize;
                Log.d("Postcard", "Upload progress - " + progress);
                uploadProgressCallback.progress(progress);
            }
