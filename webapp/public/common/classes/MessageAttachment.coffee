class MessageAttachment
  constructor: ->
    @progress = 0 #note: an NSProgress in OBJC

class MessageMedia extends MessageAttachment
  constructor: ->
    @mimeType = ""
  ...
  length: ->
    if @videoData?
      return @videoData.capacity()
    else
      return @imageData.capacity()

  setupWithContentUrl: (urlString)->
    ###
